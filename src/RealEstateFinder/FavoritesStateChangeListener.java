...
public class FavoritesStateChangeListener implements ChangeListener, Serializable {
    ...
    /**
     * Constructor which initializes the reference to the FavoritesPage instance
     * and sets the PropertyDescriptionPage and Property name fields to null
     * since this listener is only for updating the FavoritesPage
     *
     ...
     * PropertyDescriptionPage and Property name fields and sets the
     * FavoritesPage instance to null since this listener is only for updating
     ...
     * @param strategyprov reference to PropertyDescriptionPageStrategyProvider
     * instance
