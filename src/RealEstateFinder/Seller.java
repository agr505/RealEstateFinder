 ...
 */
/**
 * Class for the Account type of a Seller which holds the InteresedCustomers in
 * Property that the Seller owns and the Properties the Seller owns
 *
 * @author Aaron
 */
public class Seller extends Account implements Serializable {
    ...
    /**
     * Constructor which will call the super class Account's constructor along
     * with initializing InterestedCutomers and the Seller's list of Property
     * names the Seller owns
     *
