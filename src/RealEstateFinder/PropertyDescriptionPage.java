...
public class PropertyDescriptionPage extends JFrame {
    ...
    /**
     * Method utilizing the PropertyDescriptionPageStrategy to return the
     * customized JPanel based on the PropertyDescriptionPageStrategy algorithm,
     * then removes the current JPanel to add the newly created one
     *
     * @param strategy PropertyDescriptionPageStrategy used to return the
     * customized JPanel based on its algorithm
     */
